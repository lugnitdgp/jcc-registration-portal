...
class RegistrationForm(forms.Form):
    ...
    player_one_contact = forms.IntegerField(label='Player 1 Contact', required=True, widget=forms.NumberInput(
        attrs={'class': 'form-control form-control-sm mb-2'}))
    player_one_hall = forms.IntegerField(label='Player 1 Hall Number', required=True, widget=forms.NumberInput(
        attrs={'class': 'form-control form-control-sm mb-2'}))
    ...
    player_two_contact = forms.IntegerField(label='Player 2 Contact', required=True, widget=forms.NumberInput(
        attrs={'class': 'form-control form-control-sm mb-2'}))
    player_two_hall = forms.IntegerField(label='Player 2 Hall Number', required=True, widget=forms.NumberInput(
        attrs={'class': 'form-control form-control-sm mb-2'}))
