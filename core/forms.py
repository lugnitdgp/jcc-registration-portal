...
class RegistrationForm(forms.Form):
    team_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}))
    ...
    player_one_email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}))
    player_one_contact = PhoneNumberField(
        widget=forms.TextInput(
            attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}),
    ...
    player_one_hall = forms.CharField(
        label='Player 1 Hall Number', required=True, widget=forms.Select(
            choices=HALL_CHOICES, attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}))
    ...
    player_two_email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}))
    player_two_contact = PhoneNumberField(
        widget=forms.TextInput(
            attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}),
    ...
    player_two_hall = forms.CharField(
        label='Player 2 Hall Number', required=True, widget=forms.Select(
            choices=HALL_CHOICES, attrs={
                'class': 'form-control form-control-sm mb-2 text-dark'}))
